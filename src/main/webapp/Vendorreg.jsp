          ...
          <div class="row g-0">
            ...
            <div class="col-xl-6">
              <div class="card-body p-md-5 text-black">
                ...
                <form name="MyForm" method="post" action="VendorRegServlet" onsubmit="return validate()" enctype="multipart/form-data">
                <div class="row">
                ...
                <div class="form-outline mb-4">
                 ...
                 <div class="form-outline mb-4">
                  ...
                  <label class="form-label" for="form3Example90">Image Upload</label>
                </div>
...
function validate(){
	 ...
	 if(!allowedExtensions.exec(filePath)){
	        swal("Sorry","Please upload file having extensions .jpeg/.jpg/.png/.gif only.","error");
	        fileInput.value = '';
	        return false;
	    }
}
