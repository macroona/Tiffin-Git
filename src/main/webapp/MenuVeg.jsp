...
<body style="background-color:#DDDEE7;">
 ...
 if(cart_list != null){
  ...
  <div class=" shadow-sm p-3 mb-5 bg-body rounded" style="margin-left:4%;margin-right:4%;margin-top: 2%; ">
    ...
    <div class="card-body ">
      <ul class="nav nav-tabs border-end-0 border-success">
        <li class="nav-item ">
          <a class="nav-link" aria-current="page" href="MenuAll.jsp"
            style="color: black;">All</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active border border-success border-bottom-0 text-success" href="MenuVeg.jsp">Veg Only</a>
        </li>
        <li class="nav-item">
