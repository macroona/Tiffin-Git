 ...
 if(cart_list != null){
	 	request.setAttribute("cart_list",cart_list);
                ...
                List<Vendor> vs=(List<Vendor>)session.getAttribute("list");
	             ...
	             %>
<div class=" shadow-sm p-3 mb-5 bg-body rounded" style="margin-left:4%;margin-right:4%;margin-top: 2%; ">
    <!-- select food type open -->
    <div class="card-body ">
      <ul class="nav nav-tabs border-end-0 border-danger">
        <li class="nav-item ">
          <a class="nav-link" aria-current="page" href="MenuAll.jsp" style="color: black;">All</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="MenuVeg.jsp" style="color: black;">Veg Only</a>
        </li>
        <li class="nav-item " >
          <a class="nav-link active border border-danger border-bottom-0 text-danger" href="MenuNonVeg.jsp">Non-Veg Only</a>
        </li>
      </ul>
        ...
        <!-- Cards Of Vendors Start-->
          ...
          <div>
            <div class="row row-cols-auto justify-content-center">
              <%for(Vendor ven : vs){
            	  String type=ven.getVendortype();
            	 if(type.equals("NonVeg")){
            	  %>
              <div class="col">
              
                <div class="card mb-3 shadow p-3 mb-5 bg-body rounded" style="width: 5
                40px; margin: 1%;">
                  <div class="row g-0">
                    <div class="col-md-4">
                      <%--  <img class="rounded-start img-thumbnail" src="data:image/png;base64,<%=ven.getVendorimage() %>" style="width: 100%; height:200px"  alt="Red dot" / > --%>
